...
$tournamentObj->select($tournamentObj->objTournamentPool->objTournamentPoolMatch->get_info("tournament_id"));
$tournamentInfo = $tournamentObj->get_info_filtered();
$matchInfo = $tournamentObj->objTournamentPool->objTournamentPoolMatch->get_info_filtered();
...
echo "
<form action='".$MAIN_ROOT."members/console.php?cID=".$cID."&pID=".$_GET['pID']."' method='post' enctype='multipart/form-data'>
<div class='formDiv'>
	...
	echo "
		...
		<script type='text/javascript'>
			...
			$(document).ready(function() {
				...
				$('#matchWinner').val('".$matchInfo['winner']."');
