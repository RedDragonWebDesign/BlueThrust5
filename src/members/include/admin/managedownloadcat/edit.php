...
$(document).ready(function() {
    $('#breadCrumb').html('<a href=\'".$MAIN_ROOT."'>Home</a> > <a href=\'".$MAIN_ROOT."members\'>My Account</a> > <a href=\'".$MAIN_ROOT."members/console.php?cID=".$cID."\'>Manage Download Categories</a> > ".htmlspecialchars($downloadCatInfo['name'])."');
});
</script>
";

// Initialize $countErrors at the beginning of the script or before its first use
$countErrors = 0;
$dispError = "";
