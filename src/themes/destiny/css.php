...
$arrCSSInfo = array(
	...
	"default-border-color" => "#003f74",
	"box-bg-color" => "rgba(0,0,0,.1)",
	"box-bg-image" => "none",
	...
	"console-category-button-bg-color" => "rgba(0,0,0, .15)",
	"console-category-button-hover-bg-color" => "rgba(0,63,116, .2)",
	...
	"alternate-bg-color" => "rgba(0,0,0,.12)",
	"youtube-embed-width" => "560px",
	"youtube-embed-height" => "315px",
	"shoutbox-bg-color" => "rgba(0,0,0, .12)",
	"shoutbox-bg-image" => "none",
	"shoutbox-font-size" => "11px",
	"squad-logo-width" => "400px",
	"squad-logo-height" => "100px",
	"tournament-bracket-link-color" => "#003f74",
	"tournament-bracket-link-hover-color" => "#0086f8",
	"tournament-bracket-font-color" => "black",
	"tournament-bracket-connector-color" => "black",
	"profile-left-width" => "25%",
	...
	"forum-new-post-bg-color" => "rgba(0,0,0,.12)",
