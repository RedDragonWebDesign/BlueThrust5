...
// General functions to filter out all <, >, ", and ' symbols
	...
	function parseBBCode($strText)
	{
		...
		$strText = preg_replace("/\\[youtube\\](http|https)(\\:\\/\\/youtu\\.be\\/)(.*)\\[\\/youtube\\]/i", "<iframe class='youtubeEmbed' src='https://www.youtube.com/embed/$3?wmode=opaque' frameborder='0' allowfullscreen></iframe>", $strText);
