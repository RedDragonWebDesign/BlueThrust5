...
function parseBBCode($strText) {
	...
	$strText = is_string($strText) ? $strText : '';
	...
	$strText = preg_replace("/\[youtube\]https?:\/\/www\.youtube\.com\/watch\?v=[a-zA-Z0-9_-]+\[youtube\]/i", "<iframe class='youtubeEmbed' src='http://www.youtube.com/embed/$3?wmode=opaque' frameborder='0' allowfullscreen></iframe>", $strText);
